                ...
                <div className="extra-cell d-flex align-items-center gap-3">
                  ...
                  <form onSubmit={handleSearchSubmit} style={{ position: "relative" }}>
                    <div style={{
                      ...
                      minWidth: searchFocused ? 260 : 200,
                      boxShadow: searchFocused ? "0 4px 20px rgba(0,0,0,0.12)" : "none",
                      height: "48px" // Further increased to match larger header buttons
                    }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={isLight ? "#555" : (searchFocused ? "#555" : "rgba(255,255,255,0.8)")} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      {searchQuery && (
                        ...
                        >
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={isLight ? "#888" : "rgba(255,255,255,0.8)"} strokeWidth="2.5" strokeLinecap="round">
