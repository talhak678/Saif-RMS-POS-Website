    ...
    <>
      ...
      {footerEnabled && (
        <footer className="site-footer style-2" id="footer" style={{ backgroundColor: bgColor, color: 'white', position: 'relative' }}>
          ...
          <div className="footer-top" style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '80px', position: 'relative', zIndex: 1 }}>
          ...
          {copyrightEnabled && (
            <div className="footer-bottom" style={{ borderTop: '1px solid rgba(255,255,255,0.1)', padding: '25px 0' }}>
              <div className="container">
                <div className="row">
                  <div className="col-xl-12 text-center">
                    <span className="copyright-text" style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px' }}>
